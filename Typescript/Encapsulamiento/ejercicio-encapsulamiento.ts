class Producto {
  ...
  const producto1 = new Producto("Laptop", 1200.99, 10);
  
  // Mostrar los detalles iniciales del producto
  console.log(producto1.obtenerDetalles()); // Producto: Laptop, Precio: $1200.99, Cantidad: 10
  
  // Actualizar la cantidad en inventario
  producto1.actualizarCantidad(15);
  
  // Mostrar los detalles actualizados del producto
  console.log(producto1.obtenerDetalles()); // Producto: Laptop, Precio: $1200.99, Cantidad: 15
